...
Brewer.UploadFoto = (function() {
	...
	function UploadFoto() {
		this.inputNomeFoto = $('input[name=fotoNome]');
		this.inputContentType = $('input[name=fotoContentType]');
		this.novaFoto = $('input[name=fotoNova]');
		this.inputUrlFoto = $('input[name=fotoURL]');
